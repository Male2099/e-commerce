<template>
    <div class="h-[100vh] w-[100vw] background-opacity-70percent-black fixed top-0 z-20 flex items-center justify-center">
        <form action="#">
            <div class="py-2 pb-8 sm:px-8  h-auto flex flex-col login_backgrounImage rounded-[10px] overflow-hidden relative">
...
.py-2.login_backgrounImage {
    ...
    height: fit-content; /* set the height of the container to fit the height of its content */
}</style>