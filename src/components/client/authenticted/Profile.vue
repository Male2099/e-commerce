...
<template>
    <div class="w-full flex justify-center py-4 px-4 max-sm:p-0">
        <div class="w-[var(--fixed-width)] max-w-[100vw] p-4 max-sm:p-2 flex max-sm:flex-col max-sm:items-center gap-12 max-sm:gap-4">
            ...
            <div class="w-[75%] max-sm:w-full flex flex-col gap-4 max-sm:items-center ">
                ...
                <div class="w-[100%] ">
                    ...
                    <div>some@something.com</div>
                    <hr class="w-[76%] max-sm:w-full ">
                </div>
                <div class="w-[100%] ">
                    <div class="text-[.7rem] font-normal text-gray-500 flex gap-2 items-center">Purchase <a
                            href="/history"><img class="h-4" src="../../../assets/image/redirectArrow.svg"></a></div>
                    <div>10</div>
                    <hr class="w-[76%] max-sm:w-full">
                </div>
                <div class="w-[100%] ">
                    <div class="text-[.7rem] font-normal text-gray-500 flex gap-2 items-center">Pending order <a
                            href="/pending"><img class="h-4" src="../../../assets/image/redirectArrow.svg"></a></div>
                    <div>0</div>
                    <hr class="w-[76%] max-sm:w-full">
                </div>
                <div class="w-[100%] ">
